    ...
    <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Laporan Barang Keluar</h6>
        </nav>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="ms-4 mt-3">
                            <form action="./export_laporan_barangkeluar_excel.php" method="post">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-b text-center text-xs font-weight-bold "><?= $row['tujuan'] ?></td>
