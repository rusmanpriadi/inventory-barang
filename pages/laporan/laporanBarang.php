      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Laporan barang</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Laporan Barang</h6>
        </nav>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between">
                            ...
                            <div class="button-export">
                                ...
                                <a href="./export_laporan_barang_excel.php" class="btn btn-success  btn-sm me-2">ExportToExel+</a>
                                ...
                                <table class="table align-items-center" id="tableS">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td class="td-b text-center text-xs font-weight-bold "><?= $no++ ?></td>
                                                <td class="td-b text-center text-xs font-weight-bold "><?= $row['kodeBarang'] ?></td>
                                                <td class="td-b text-center text-xs font-weight-bold "><?= $row['namaBarang'] ?></td>
                                                <td class="td-b text-center text-xs font-weight-bold "><?= $row['jenisBarang'] ?></td>
