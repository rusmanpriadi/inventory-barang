  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body ">
                    ...
                    <form method="POST" action="./aksijenis.php">
                      <div class="row">
                        
                        <div class="col">
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingTextInput2" placeholder="Smith"  name="jenis_barang" required>
        ...
        include '../../koneksi.php';
            $no = 1;
            $employee = mysqli_query($koneksi, "SELECT * fROM jenisbarang ORDER BY id DESC");
  ...
  <tr>
    ...
    <td class="text-xs font-weight-bold  d-flex justify-content-center">
      ...
      <button class="btn bg-gradient-primary btn-xs ms-2 " data-bs-toggle="modal" data-bs-target="#editModal<?= $no ?>" data-bs-whatever="@mdo">Edit</button>
            <a href="./hapusJenis.php?id=<?php echo $row['id']; ?>" class="btn bg-gradient-danger btn-xs ms-2 deletedUser" data-toggle="modal" data-original-title="Edit user" name="hapus" >Hapus</a>
      </div>
    </td>
                  ...
                  <div class="modal-body">
                    ...
                    <input type="hidden" name="id_code" value="<?= $row['id']?>">
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingTextInput2" placeholder="Smith"  name="jenis_barang" value="<?= $row['jenisBarang'] ?>" required>
